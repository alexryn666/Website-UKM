...
<body>
                    ...
                    <div class="row gx-0 align-items-center">
                        <div class="col-lg-8 text-center text-lg-center mb-lg-0">
                            <div class="d-flex flex-wrap">
                                <div class="pe-4">
                                    <a href="mailto:gendewageni25@gmail.com" class="text-muted small"><i
                                            class="fas fa-envelope text-primary me-2"></i>gendewageni25@gmail.com</a>
                                </div>
                                <div class="pe-0">
                                    <a href="mailto:gendewageni25@gmail.com" class="text-muted small"><i
                                            class="fa fa-clock text-primary me-2"></i>Senin dan Jumat 16:00 - 19:00</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="navbar-nav mx-0 mx-lg-auto">
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="/berlangsung" class="dropdown-item active">Kegiatan Akan
                                            Berlangsung</a>
                                ...
                                <div class="nav-btn ps-3">
                                    ...
                                    <a href="/contact" class="btn btn-primary py-2 px-4 ms-0 ms-lg-3"> <span>Hubungi
                                            Admin</span></a>
                                </div>
    ...
    <section class="page-section portfolio" id="partner">
        <div class="container">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Daftar Kegiatan</h2>
            <!-- Icon Divider-->
